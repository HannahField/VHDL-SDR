...
### SC-FDMA
Single-Carrier Frequency Divsion Multiple Access, SC-FDMA, is a modification to OFDM, which trades complexity for a lower peak-to-average power. This is done by including a DFT precoding, which causes the subcarriers to become deeply correlated.
