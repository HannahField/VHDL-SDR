...
entity Symbol_Shaper is
	generic(
	logM : natural := 4 -- Which QAM. Default 16QAM
	);
	port(
	CLK : in std_logic;
	RST : in std_logic;
	
	INPUT_RE : in std_logic_vector((logM/2)-1 downto 0);
	INPUT_IM : in std_logic_vector((logM/2)-1 downto 0);
